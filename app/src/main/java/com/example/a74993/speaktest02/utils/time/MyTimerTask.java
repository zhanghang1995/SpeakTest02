...
public class MyTimerTask extends TimerTask {
    ...
    public void run() {
         ...
         */
        if (name.equals("起床")&&(TimeUtils.getSystemClockUpper().toString()).equals("11:59")) {
            SpeechUpload.upload("起床", context_this, 0);
            LogInfo.e("当前系统时间", (TimeUtils.getSystemClockUpper().toString().trim()));
            LogInfo.e("Thread", "起床服务");
        }else if((TimeUtils.getSystemClockUpper().toString()).equals("12:00")){  //早饭服务
        ...
        }else if((TimeUtils.getSystemClockUpper().toString()).equals("12:02")){   //午饭服务
        ...
        }else if((TimeUtils.getSystemClockUpper().toString()).equals("11:53")){   //晚饭服务
