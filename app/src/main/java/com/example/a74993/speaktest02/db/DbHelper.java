...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public DbHelper(Context context) {
        ...
        LogInfo.e("SQLITE", "DatabaseHelper Constructor");
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        LogInfo.e("SQLITE", "数据库创建");

        // 构建创建表的SQL语句（可以从SQLite Expert工具的DDL粘贴过来加进StringBuffer中）
        StringBuffer sBuffer = new StringBuffer();

        sBuffer.append("CREATE TABLE [" + TABLE_NAME + "] (");
        sBuffer.append("[deviceId] varchar(30) PRIMARY KEY,");
        sBuffer.append("[username] varchar(30) NOT NULL ,");
        sBuffer.append("[getuptime] time ,");
        sBuffer.append("[breaktime] time ,");
        sBuffer.append("[breaktype] varchar(30) ,");
        sBuffer.append("[schedule] varchar(30) ,");
        sBuffer.append("[lunchtime] time ,");
        sBuffer.append("[lunchtype] varchar(30) ,");
        sBuffer.append("[dinnertime] time ,");
        sBuffer.append("[dinnertype] varchar(30) )");
        // 执行创建表的SQL语句
